...
In order to support loading of multiple wallets in nv-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nv.cpp.
...
Changes to nv.cpp
----------------------
nv.cpp is the entry point into nv-qt, and as such, will require some minor modifications to provide hooks for
