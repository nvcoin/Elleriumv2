NV Core version 2.2.1 is now available from:

  <https://github.com/nv-project/nv/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/nv-project/nv/issues>

Compatibility
==============

NV Core is extensively tested on multiple operating systems using
...
NV Core should also work on most other Unix-like systems but is not
...
of Bitcoin that NV was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/nv-project-translations/).
