                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NV Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NV address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nv: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NV Core"), this);
    aboutAction->setStatusTip(tr("Show information about NV Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NV"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NV addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NV addresses"));
    ...
    openAction->setStatusTip(tr("Open a NV: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NV Core help message to get a list with possible NV command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NV Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NV network", "", count));
}
...
{
    QString strTitle = tr("NV Core"); // default title
