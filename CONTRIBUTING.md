Contributing to NV Core
============================

The NV Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NV Core project, and is not to be
confused with overall NV Network Protocol consensus changes.

Whether a pull request is merged into NV Core rests with the project merge
...
Patches that change NV consensus rules are considerably more involved than
...
Where a patch set proposes to change the NV consensus, it must have been
...
The project leader is the release manager for each NV Core release.
